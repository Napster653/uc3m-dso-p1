...
static int current = 0;	// Currently running thread
static int init=0;		// Variable indicating if the library is initialized (init == 1) or not (init == 0)
static TCB idle;		// Thread control block for the idle thread
static void idle_function()
{
	while(1);
=======
